...
const CONTACT_LINKS = [
  {
    ...
    display: 'yourname@university.edu',
    icon: <Mail size={16} />,
  },
  {
    label: 'ORCID',
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="flex-1 space-y-4">
          <div>
            ...
            <p className="text-lg text-muted-foreground">
              Ph.D. Candidate in [Your Department]
            </p>
          ...
          <p className="text-foreground leading-relaxed">
            Welcome! I am a doctoral student in [Your Department] at [Your University],
            advised by [Your Advisor]. My research focuses on [brief description of your
            research interests and goals — what problems you work on and why they matter].
          </p>
          <p className="text-foreground leading-relaxed">
            Before joining [Your University], I completed my [undergraduate/master's]
            degree at [Previous Institution]. I am passionate about [your broader
            motivations or mission as a researcher].
          </p>
      ...
      <section>
        ...
        <div className="space-y-3">
          {[
            { date: 'April 2026', text: 'Paper accepted at [Conference Name].' },
