...
const CONTACT_LINKS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" aria-hidden="true">
        <path d="M5.242 13.769L0 9.5 12 0l12 9.5-5.242 4.269C17.548 11.249 14.978 9.5 12 9.5c-2.977 0-5.547 1.748-6.758 4.269zM12 10a7 7 0 1 0 0 14 7 7 0 0 0 0-14z" />
      </svg>
    ),
  },
  {
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="flex flex-col md:flex-row items-start gap-10 mb-12">
        <div className="flex-1 space-y-4">
          ...
          <p className="text-foreground leading-relaxed">
            ...
            <a
              href="https://www.unomaha.edu/college-of-public-affairs-and-community-service/criminology-and-criminal-justice/about-us/sarah-al-falatah.php"
              target="_blank"
              rel="noopener noreferrer"
            ...
            at the University of Nebraska at Omaha. I am a health criminologist with
            an emphasis on mental and physical health within the criminal justice
            system and a secondary focus on violence prevention and program
            evaluation.
          </p>
          <p className="text-foreground leading-relaxed">
            My research explores health conditions as both precursors and
            consequences of criminal justice involvement and victimization.
            Specifically, I examine how mental and physical health shape pathways
            into offending and victimization, and how those experiences may amplify
            future health conditions. My dissertation evaluates the implementation
      ...
      <section>
        ...
        <div className="space-y-3">
          {[
            { date: 'August 2026', text: <a href="https://link.springer.com/article/10.1186/s40352-026-00443-y" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Publication: A mixed-methods study of suicide attempts</a> },
